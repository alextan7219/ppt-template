...
Sub GeneratePowerPointFromTemplate_v1()
    ...
    templatePath = Environ("TEMP") & "\TP_Template_ATAP_Big_above_8.04.pptx"   ' Temporary local copy
    
    Dim templateURL As String
    templateURL = "https://raw.githubusercontent.com/alextan7219/ppt-template/main/TP%20Template_ATAP_Big_above_8.04.pptx"
